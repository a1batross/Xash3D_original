...
qboolean S_Init( void )
{
	...
	s_volume = Cvar_Get( "volume", "0.5", CVAR_ARCHIVE, "sound volume" );
	s_musicvolume = Cvar_Get( "musicvolume", "0.3", CVAR_ARCHIVE, "background music volume" );
	...
	s_lerping = Cvar_Get( "s_lerping", "1", CVAR_ARCHIVE, "apply interpolation to sound output" );
	s_ambient_level = Cvar_Get( "ambient_level", "0.3", CVAR_ARCHIVE, "volume of environment noises (water and wind)" );
	s_ambient_fade = Cvar_Get( "ambient_fade", "2500", CVAR_ARCHIVE, "rate of volume fading when client is moving" );
